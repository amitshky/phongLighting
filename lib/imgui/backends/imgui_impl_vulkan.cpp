...
//  2023-01-02: Vulkan: Fixed sampler passed to ImGui_ImplVulkan_AddTexture() not being honored + removed a bunch of
//  duplicate code. 2022-10-11: Using 'nullptr' instead of 'NULL' as per our switch to C++11. 2022-10-04: Vulkan: Added
//  experimental ImGui_ImplVulkan_RemoveTexture() for api symetry. (#914, #5738). 2022-01-20: Vulkan: Added support for
//  ImTextureID as VkDescriptorSet. User need to call ImGui_ImplVulkan_AddTexture(). Building for 32-bit targets
//  requires '#define ImTextureID ImU64'. (#914). 2021-10-15: Vulkan: Call vkCmdSetScissor() at the end of render a
//  full-viewport to reduce likehood of issues with people using VK_DYNAMIC_STATE_SCISSOR in their app without calling
